...
This folder contains a structured, developer-oriented version of the original document "ITX3007 SE HemaWeb Project Final".

Use this as the entry point to understand the problem, requirements, design, and project planning for HemaWeb.

## Files

- `project-overview.md` - high-level context, problem, objectives, and how the app helps donors and hospitals.
...
- `ui_donor.md` - donor-facing (mobile web) UI.
...
All diagrams and screenshots from the original document are now in:
